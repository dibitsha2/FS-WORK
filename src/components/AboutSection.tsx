...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-32 bg-luxury-dark-secondary relative overflow-hidden font-algerian">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-8">
            <div>
              <span className="text-luxury-gold text-xl font-light tracking-[0.3em] uppercase mb-6 flex items-center">
                <div className="w-12 h-0.5 bg-luxury-gold mr-4"></div>
                About Excellence
              </span>
              <h2 className="text-5xl md:text-6xl font-light text-luxury-text mb-8 leading-tight font-freestyle-script">
                Crafting <span className="text-luxury-gold">Royal</span> Spaces
              </h2>
              <p className="text-luxury-text-muted text-xl leading-relaxed font-light font-calibri">
                ...
                >
                  <div className={`flex items-start space-x-6 p-6 rounded-xl transition-all duration-500 ${
                    ...
                    <div className="flex-1">
                      <h3 className="text-luxury-text text-xl font-semibold mb-3 group-hover:text-luxury-gold transition-colors duration-300 font-freestyle-script">
                        {feature.title}
                      </h3>
                      <p className="text-luxury-text-muted leading-relaxed font-calibri font-light">
                        {feature.description}
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-luxury-gold/20">
              <div className="text-center">
                ...
                <div className="text-luxury-text-muted text-sm tracking-wide font-calibri font-light">Luxury Projects</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-luxury-gold mb-2">98%</div>
                <div className="text-luxury-text-muted text-sm tracking-wide font-calibri font-light">Client Satisfaction</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-luxury-gold mb-2">15+</div>
                <div className="text-luxury-text-muted text-sm tracking-wide font-calibri font-light">Awards Won</div>
              </div>
            </div>
          </div>
